...
Session: Stable | 12% used (24k) | topics:2 · resolved concepts:4 · loose ends:1 · ai misunderstandings corrected:0 · cli tool fails:1/31   ← the gauge
...
```
Session: Restart Recommended | 42% used (84k) | topics:3 · resolved concepts:2 · loose ends:1 · ai misunderstandings corrected:2 · cli tool fails:0/58 · compactions:1
```
...
| AI misunderstandings corrected (user corrections) | judge; repeats matched against prior corrections | 2+ in the session | same issue corrected 3+ times (Anthropic's clear-and-restart rule) |
