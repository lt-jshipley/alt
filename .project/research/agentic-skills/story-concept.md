...
- **The one-way test does not fire after reading code.** Four of five story-refine runs wrote the mechanism as criterion one and called it settled by the record → story-refine is retired once the builder's pass exists; no further edits to it. (open)
